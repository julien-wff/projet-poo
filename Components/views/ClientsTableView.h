...
{
    public ref class ClientsTableView : public System::Windows::Forms::UserControl
    {
    public:
        ClientsTableView(void)
        {
            InitializeComponent();
        }
    ...
    public:
        ...
        event EventHandler<int>^ ClientClick;
...
#pragma region Windows Form Designer generated code
        void InitializeComponent(void)
        {
            ...
            this->TableHeader->Label = L"Liste des clients";
            ...
            this->TableHeader->RefreshClick += gcnew System::EventHandler(
                this, &ClientsTableView::TableHeader_RefreshClick);
            this->TableHeader->AddClick += gcnew System::EventHandler(
                this, &ClientsTableView::TableHeader_AddClick);
            // 
            // TableDisplay
            // 
            ...
            this->TableDisplay->Load += gcnew System::EventHandler(this, &ClientsTableView::TableDisplay_Load);
            this->TableDisplay->RowSelect += gcnew System::EventHandler<DataRow^>(
                this, &ClientsTableView::TableDisplay_RowSelected);
            // 
            // ClientsTableView
            // 
...
#pragma endregion
    ...
    private:
        ...
        {
            this->ClientClick(this, safe_cast<int>(row["id"]));
        }

    public:
        void LoadData()
        {
            auto clientService = gcnew Services::ClientService();
            auto clients = clientService->GetClients();
            this->TableDisplay->SetDataSource(clients);
        }
    };
}
